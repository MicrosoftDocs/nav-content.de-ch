...
Sobald Sie die Daten einmal eingeben haben, können Sie die Offerte buchen. Sie können es dann per E-Mail senden. Dynamics NAV erzeugt eine .PDF-Datei mit der Verkaufsofferte und fügt sie der E-Mail, deren Entwurf Sie im Add-In erstellt haben, an.  
...
Das Dynamics NAV Belegverknüpfungs-Add-In bietet Ihnen schnellen Zugriff auf Belege, die in E-Mails angegeben wurden. Das Add-In ist für eine E-Mail verfügbar, wenn im Text der Nachricht eine Belegnummer erkannt wird. Das Öffnen des Add-Ins bietet schnellen Zugriff auf den Beleg.  
...
Im Belegverknüpfungs-Add-In können Sie genauso Vorgänge für den Beleg ausführen und den Beleg ändern, wie in Dynamics NAV.
