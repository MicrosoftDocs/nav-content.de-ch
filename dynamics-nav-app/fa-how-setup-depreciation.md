---
title: 'So geht''s: Einrichten der Anlagen-Abschreibung'
author: SorenGP
ms.custom: na
ms.date: 09/22/2016
ms.reviewer: na
...
Für jedes Abschreibungsbuch müssen Sie festlegen, wie Dynamics NAV die verschiedenen Buchungsarten verarbeiten soll. Beispielsweise ob Buchungen Soll- oder Habenposten sein sollen und ob die Buchungsart in der AfA-Grundlage enthalten sein soll.  
1.  Wählen Sie in der rechten oberen Ecke das Symbol **Nach Seite oder Bericht suchen** und geben **AfA-Bücher** ein. Wählen Sie dann den zugehörigen Link aus.  
...
Sie können für jedes Abschreibungsbuch Vorgaben für Vorlagen und Erfassungsjournalen definieren. Diese Vorgaben werden für Folgendes verwendet:
- Kopieren von Zeilen von einem Erfassungsjournal in ein anderes
- Erstellen Sie Buch.-Blattzeilen durch die Stapelverarbeitungen **AfA berechnen** oder **Indexierte Anlagen**.
- Kopieren von Anschaffungskosten im Versicherungs Erfassungsjournal
