...
Die WIP-Berechnung kann auf der Basis der folgenden Optionen erfolgen:
...
**Hinweis**: Die Stapelverarbeitung berechnet nur den WIP. Er wird nicht auf das Fibukonto gebucht. Dazu müssen Sie die Stapelverarbeitung **WIP nach Sachposten Projekt** ausführen, nachdem Sie den WIP berechnet haben. Weitere Informationen finden Sie in der folgenden Prozedur.
