...
1. Wählen Sie in der rechten oberen Ecke das Symbol **Nach Seite oder Bericht suchen** und geben **Neubewertung Buch.-Blatt** ein. Wählen Sie dann den zugehörigen Link aus.
2. Wählen Sie die Aktion **Lagerwert berechnen** aus.
3. Füllen Sie im Fenster **Lagerwert berechnen** die Felder nach Bedarf aus. Wählen Sie ein Feld aus, um eine kurze Beschreibung des Feldes zu lesen oder einen Link für weitere Informationen zu öffnen.
